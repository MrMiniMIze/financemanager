...
export function LoginSection({
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatus('success');
      setMessage(
        `Welcome back, ${resolveDisplayName(parsed.data.email)}. Redirecting to your dashboard...`,
      );
        ...
        <Card>
          ...
          <CardBody>
            <p className={styles.helperText}>
              We use Argon2 password hashing, device-based session tracking, and per-session anomaly
              detection to keep your account safe.
            </p>
            ...
            <p className={styles.helperText}>
              Need help? Contact support and reference the email {friendlyName || 'on file'} used
              for login.
            </p>
          </CardBody>
        </Card>
