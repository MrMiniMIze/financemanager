...
export function BillsSectionSkeleton() {
  return (
    <section
      className={`${patterns.section} ${styles.section}`}
      aria-busy="true"
      aria-live="polite"
    >
          ...
          <Card key={`bills-summary-skeleton-${index}`}>
            ...
            <CardBody className={styles.summaryCard}>
              <Skeleton
                ...
                style={{ width: '45%', height: '1.6rem' }}
              />
              <Skeleton
                className={patterns.skeletonText}
                style={{ width: '70%', marginTop: '0.4rem' }}
              />
              <Skeleton
                className={patterns.skeletonText}
                style={{ width: '60%', marginTop: '0.4rem' }}
              />
            </CardBody>
          </Card>
        ))}
      ...
      <div className={styles.layout}>
        <Card className={styles.scheduleCard}>
          ...
          >
            ...
            <Skeleton
              className={patterns.skeletonText}
              style={{ width: '18rem', marginTop: '0.4rem' }}
            />
          </CardHeader>
          <CardBody>
