...
export function BillsSection() {
  ...
  const referenceDate = useMemo(
    () => (data ? getStartOfDay(toDate(data.referenceDate)) : null),
    [data],
  );
      ...
      <div className={styles.summaryGrid}>
        <Card>
          ...
          <CardBody className={styles.summaryCard}>
            <span className={styles.summaryMetric}>
              {centsToCurrency(summary.dueThisMonthCents)}
            </span>
        ...
        <Card>
          ...
          <CardBody className={styles.summaryCard}>
            ...
            <span className={styles.summaryTrend}>Last auto-pay recorded on Sep 1 for rent</span>
          </CardBody>
        </Card>
        <Card>
        ...
        <Card className={styles.scheduleCard}>
          ...
          <CardBody className={styles.scheduleCard}>
            <div className={styles.scheduleLegend}>
              ...
              <span>
                <span className={`${styles.colorDot} ${styles.colorUpcoming}`} /> Upcoming /
                Auto-pay
              </span>
            </div>
                      ...
                      <div className={styles.billRow} key={bill.id}>
                        ...
                        <div>
                          <div className={styles.amountDue}>
                            {centsToCurrency(bill.amountCents)}
                          </div>
                          {isPaid && bill.lastPaidAt ? (
                            ...
                            <div className={styles.nextReminder}>
                              Next reminder{' '}
                              {dateFormatter.format(toDate(nextReminder.scheduledFor))}
                            </div>
                          ) : null}
                        </div>
              ...
              <div className={styles.remindersList}>
                {reminders.map((reminder) => (
                  <div className={styles.reminderItem} key={reminder.id}>
                    ...
                    <span className={styles.reminderMeta}>
                      {reminder.billName} • Due {dateFormatter.format(toDate(reminder.billDueDate))}{' '}
                      • {centsToCurrency(reminder.amountCents)}
                    </span>
